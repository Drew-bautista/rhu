...
<div class="sidenav" id="sidenav">
    ...
    <div class="sidebar-watermark-bg" style="color: rgba(255, 0, 0, 0.18); font-size: 24px; font-weight: bold; text-shadow: 0 0 2px rgba(255,255,255,0.3);">NOT PAID</div>
    <div class="sidebar-watermark" style="color: rgba(255, 0, 0, 0.35); font-size: 12px; font-weight: bold; text-shadow: 0 0 1px rgba(255,255,255,0.5);">
        TRIAL VERSION<br>
        <small style="font-size: 10px; font-weight: bold;">NOT PAID</small>
    </div>
    
    {{-- Heavier Watermarks After Expiration --}}
    @if($isExpired)
        <div class="sidebar-watermark-bg" style="color: rgba(255, 0, 0, 0.15); font-size: 24px;">EXPIRED</div>
        <div class="sidebar-watermark" style="color: rgba(255, 0, 0, 0.2); font-size: 10px;">
            SYSTEM EXPIRED<br>
            <small style="font-size: 8px;">LICENSE EXPIRED</small>
        </div>
    @endif
