        ...
        <div class="container position-relative">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('staff.vaccines.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="age_group" id="age_group" class="form-select" required>
                                    ...
                                    <option value="child" {{ old('age_group') == 'child' ? 'selected' : '' }}>Child</option>
                                    <option value="adolescent" {{ old('age_group') == 'adolescent' ? 'selected' : '' }}>Adolescent</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="vaccine_type" id="vaccine_type" class="form-control" value="{{ old('vaccine_type') }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="dose_number" class="form-label">Dose Number <span class="text-danger">*</span></label>
                                <input type="text" name="dose_number" id="dose_number" class="form-control" value="{{ old('dose_number') }}" required>
                            </div>

                            <div class="col-md-4">
                                <label for="date_administered" class="form-label">Date Administered <span class="text-danger">*</span></label>
                                <input type="date" name="date_administered" id="date_administered" class="form-control" value="{{ old('date_administered') }}" required>
                            </div>
                            <div class="col-md-4">
                                <label for="next_dose_date" class="form-label">Next Dose Date</label>
                                <input type="date" name="next_dose_date" id="next_dose_date" class="form-control" value="{{ old('next_dose_date') }}">
                            </div>
                            <div class="col-md-4">
                                <label for="administered_by" class="form-label">Administered By <span class="text-danger">*</span></label>
                                <input type="text" name="administered_by" id="administered_by" class="form-control" value="{{ old('administered_by') }}" required>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="adverse_reactions" id="adverse_reactions" class="form-control" value="{{ old('adverse_reactions') }}">
                            </div>
                        ...
                        <div class="mt-4 text-end">
                            <button type="submit" class="btn btn-primary">Save Vaccine Record</button>
                        </div>
                    </form>
                </div>
            </div>
