                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center justify-content-between ">
                        ...
                        <div>
                            ...
                            <form action="{{ route('staff.family-planning.destroy', $familyPlanning->id) }}" method="POST"
                    ...
                    <div class="position-absolute top-0 end-0 mt-4 me-4">
                        <a href="{{ route('staff.family-planning.index') }}" class="text-dark" style="font-size: 1.25rem;">
