            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center justify-content-between ">
                        ...
                        <div>
                            {{-- <a href="{{ route('staff.infirmary.edit', $infirmary->id) }}" class="btn btn-primary btn-sm"><i
                                    class="fa fa-edit"></i></a> --}}
                            <form action="{{ route('staff.infirmary.destroy', $infirmary->id) }}" method="POST"
                                style="display:inline;">
                                @csrf
                                @method('DELETE')
                                {{-- <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal{{ $infirmary->id }}">
                                    <i class="fas fa-trash"></i>
                                </button> --}}

                                <!-- Modal -->
                                <div class="modal fade" id="deleteModal{{ $infirmary->id }}" tabindex="-1"
                                    aria-labelledby="deleteModalLabel{{ $infirmary->id }}" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel{{ $infirmary->id }}">
                                                    Confirm
                                                    Deletion</h5>
                    ...
                    <div class="position-absolute top-0 end-0 mt-4 me-4">
                        <a href="{{ route('staff.infirmary.index') }}" class="text-dark" style="font-size: 1.25rem;">
