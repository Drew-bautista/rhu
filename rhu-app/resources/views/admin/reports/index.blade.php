        ...
        <div class="container">
                    ...
                    <form method="GET" action="{{ route('admin.reports.index') }}">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                ...
                                <a href="{{ route('admin.reports.export', request()->all()) }}" class="btn btn-info">
                            ...
                            <tbody>
                                @forelse($appointments as $appointment)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.reports.patient-history', $appointment->name) }}" 
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="{{ route('admin.reports.monthly', [date('n'), date('Y')]) }}" 
                               class="btn btn-primary btn-block">
                                <i class="fas fa-calendar-alt"></i> Current Month Report
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('admin.reports.monthly', [date('n', strtotime('-1 month')), date('Y', strtotime('-1 month'))]) }}" 
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('admin.reports.export', ['start_date' => date('Y-m-01'), 'end_date' => date('Y-m-t')]) }}" 
