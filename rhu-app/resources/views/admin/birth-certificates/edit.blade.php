                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="{{ route('admin.birth-certificates.show', $birthCertificate->id) }}" class="text-dark" style="font-size: 1.25rem;">
                        ...
                        <form action="{{ route('admin.birth-certificates.update', $birthCertificate->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="date" name="date_of_birth" class="form-control" 
                                            value="{{ old('date_of_birth', $birthCertificate->date_of_birth ? $birthCertificate->date_of_birth->format('Y-m-d') : '') }}" required>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Time of Birth</label>
                                        <input type="time" name="time_of_birth" class="form-control" 
                                            value="{{ old('time_of_birth', $birthCertificate->time_of_birth ? $birthCertificate->time_of_birth->format('H:i') : '') }}">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="date" name="mother_date_of_birth" class="form-control" 
                                            value="{{ old('mother_date_of_birth', $birthCertificate->mother_date_of_birth ? $birthCertificate->mother_date_of_birth->format('Y-m-d') : '') }}">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="date" name="father_date_of_birth" class="form-control" 
                                            value="{{ old('father_date_of_birth', $birthCertificate->father_date_of_birth ? $birthCertificate->father_date_of_birth->format('Y-m-d') : '') }}">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Age at Birth</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="date" name="date_registered" class="form-control" 
                                            value="{{ old('date_registered', $birthCertificate->date_registered ? $birthCertificate->date_registered->format('Y-m-d') : '') }}">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="remarks" class="form-control" rows="3">{{ old('remarks', $birthCertificate->remarks) }}</textarea>
                                    </div>
                                </div>
                            </div>
