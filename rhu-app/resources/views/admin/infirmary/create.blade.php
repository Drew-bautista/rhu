        ...
        <div class="container">
            <div class="row">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('admin.infirmary.index') }}" class="btn btn-secondary bg-none btn-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin.infirmary.store') }}" method="POST">
                    @csrf
                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_no" id="contact_no" pattern="\d{11}" maxlength="11" required>
