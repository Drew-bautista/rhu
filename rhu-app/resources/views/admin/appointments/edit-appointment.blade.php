        ...
        <div class="container">
            <div class="row">
                <div class="d-flex align-items-center justify-content-between">
                    <h1 class="display-6 fw-500">Edit Appointment</h1>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="John Doe" value="{{ old('name', $appointment->name) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="age" id="age" class="form-control"
                                    placeholder="Enter Age" value="{{ old('age', $appointment->age) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_number" id="contact_number" class="form-control"
                                    value="{{ old('contact_number', $appointment->contact_number) }}" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="date_of_appointment" id="date_of_appointment"
                                    class="form-control"
                                    value="{{ old('date_of_appointment', $appointment->date_of_appointment) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="address" class="form-control"
                                    value="{{ old('address', $appointment->address) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="service" id="service" class="form-control"
                                    placeholder="Enter Service" value="{{ old('service', $appointment->service) }}"
                                    required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="emergency_contact" id="emergency_contact" class="form-control"
                                    value="{{ old('emergency_contact', $appointment->emergency_contact) }}" required>
                            </div>
                        </div>
