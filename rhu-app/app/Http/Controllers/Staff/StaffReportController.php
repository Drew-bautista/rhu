...
class StaffReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('staff.reports.index', compact('appointments', 'statistics'));
    }
    ...
    public function patientHistory($patientName)
    {
        ...
        return view('staff.reports.patient-history', compact(
            'patientName',
            'appointments',
            'infirmaryRecords',
            'dentalRecords',
    ...
    public function generateMonthlyReport($month, $year)
    {
        ...
        return view('staff.reports.monthly', compact('data', 'month', 'year'));
    }
    ...
    public function exportReport(Request $request)
    {
        ...
        return view('staff.reports.export', compact('appointments'));
    }
}
