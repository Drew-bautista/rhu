        ...
        <div class="container position-relative">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('staff.animal-bite.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="date_of_incident" id="date_of_incident" value="{{ old('date_of_incident') }}" class="form-control">
                            </div>

                            <div class="col-md-6">
                                <label for="animal_type" class="form-label">Animal Type</label>
                                <input type="text" name="animal_type" id="animal_type" value="{{ old('animal_type') }}" class="form-control">
                            </div>

                            <div class="col-md-6">
                                <label for="bite_site" class="form-label">Bite Site</label>
                                <input type="text" name="bite_site" id="bite_site" value="{{ old('bite_site') }}" class="form-control">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="bite_category" id="bite_category" class="form-select">
                                    ...
                                    <option value="I" {{ old('bite_category') == 'I' ? 'selected' : '' }}>Category I</option>
                                    <option value="II" {{ old('bite_category') == 'II' ? 'selected' : '' }}>Category II</option>
                                    <option value="III" {{ old('bite_category') == 'III' ? 'selected' : '' }}>Category III</option>
                                </select>
                            </div>

                            <div class="col-md-6">
                                <label for="arv_dose" class="form-label">ARV Dose</label>
                                <input type="text" name="arv_dose" id="arv_dose" value="{{ old('arv_dose') }}" class="form-control">
                            </div>
