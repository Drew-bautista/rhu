            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Edit Vaccine Record</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.vaccines.update', $vaccine->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('patient_name') is-invalid @enderror" 
                                           id="patient_name" name="patient_name" value="{{ old('patient_name', $vaccine->patient_name) }}" required>
                                    @error('patient_name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control @error('appointment_id') is-invalid @enderror" 
                                        ...
                                        @foreach($appointments as $appointment)
                                            <option value="{{ $appointment->id }}" {{ old('appointment_id', $vaccine->appointment_id) == $appointment->id ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror" 
                                           id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $vaccine->date_of_birth->format('Y-m-d')) }}" required>
                                    @error('date_of_birth')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('age') is-invalid @enderror" 
                                           id="age" name="age" value="{{ old('age', $vaccine->age) }}" required>
                                    @error('age')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control @error('age_group') is-invalid @enderror" 
                                        ...
                                        <option value="infant" {{ old('age_group', $vaccine->age_group) == 'infant' ? 'selected' : '' }}>Infant (0-1 year)</option>
                                        <option value="child" {{ old('age_group', $vaccine->age_group) == 'child' ? 'selected' : '' }}>Child (2-12 years)</option>
                                        <option value="adolescent" {{ old('age_group', $vaccine->age_group) == 'adolescent' ? 'selected' : '' }}>Adolescent (13-17 years)</option>
                                        <option value="adult" {{ old('age_group', $vaccine->age_group) == 'adult' ? 'selected' : '' }}>Adult (18-59 years)</option>
                                        <option value="senior" {{ old('age_group', $vaccine->age_group) == 'senior' ? 'selected' : '' }}>Senior (60+ years)</option>
                                    </select>
                                    @error('age_group')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('contact_number') is-invalid @enderror" 
                                           id="contact_number" name="contact_number" value="{{ old('contact_number', $vaccine->contact_number) }}" 
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror" 
                                           id="address" name="address" value="{{ old('address', $vaccine->address) }}" required>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('vaccine_type') is-invalid @enderror" 
                                           id="vaccine_type" name="vaccine_type" value="{{ old('vaccine_type', $vaccine->vaccine_type) }}" required>
                                    @error('vaccine_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('dose_number') is-invalid @enderror" 
                                           id="dose_number" name="dose_number" value="{{ old('dose_number', $vaccine->dose_number) }}" 
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control @error('date_administered') is-invalid @enderror" 
                                           id="date_administered" name="date_administered" value="{{ old('date_administered', $vaccine->date_administered->format('Y-m-d')) }}" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control @error('next_dose_date') is-invalid @enderror" 
                                           id="next_dose_date" name="next_dose_date" value="{{ old('next_dose_date', $vaccine->next_dose_date ? $vaccine->next_dose_date->format('Y-m-d') : '') }}">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('batch_number') is-invalid @enderror" 
                                           id="batch_number" name="batch_number" value="{{ old('batch_number', $vaccine->batch_number) }}">
                                    @error('batch_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control @error('expiry_date') is-invalid @enderror" 
                                           id="expiry_date" name="expiry_date" value="{{ old('expiry_date', $vaccine->expiry_date ? $vaccine->expiry_date->format('Y-m-d') : '') }}">
                                    @error('expiry_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('adverse_reactions') is-invalid @enderror" 
                                           id="adverse_reactions" name="adverse_reactions" value="{{ old('adverse_reactions', $vaccine->adverse_reactions) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('remarks') is-invalid @enderror" 
                                          id="remarks" name="remarks" rows="3">{{ old('remarks', $vaccine->remarks) }}</textarea>
                                @error('remarks')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update Vaccine Record
                                </button>
                            </div>
                        </form>
                    </div>
